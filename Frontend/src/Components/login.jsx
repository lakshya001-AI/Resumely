        ...
        <div className={Style.loginDivMain}>
          ...
          <div className={Style.loginDiv1}>
            <div className={Style.loginContentDiv}>
              <h1 className={Style.loginContentDivHeading}>Sign in to Resumely</h1>
              <p className={Style.loginContentDivPara}>Elevate Your Career. Unlock Potential. Start Your Journey with Resumely.</p>
